# Contributing to Assemblib

## Create an issue

- If you've encountered a bug, open a [Bug Report](https://github.com/PoCInnovation/Assemblib/issues/new?assignees=&labels=&template=bug_report.md&title=).
- If you want Assemblib to have a new functionality, open a [Feature Request](https://github.com/PoCInnovation/Assemblib/issues/new?assignees=&labels=&template=feature_request.md&title=).

## Resolve an issue

Select an [issue](https://github.com/PoCInnovation/Assemblib/issues) that you want to resolve.

The recommended workflow is to fork this repository and open pull requests from your fork.

### 1. Fork, clone & configure Assemblib upstream
...
git clone git@github.com:PoCInnovation/Assemblib.git

# Add your fork as a remove
git remote add <fork_name> https://github.com/$YOUR_GITHUB_USER/Assemblib.git
```
...
# Create a new pull request from https://github.com/PoCInnovation/Assemblib/pulls
```
